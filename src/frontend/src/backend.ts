...
export class Backend implements backendInterface {
    ...
    async getAllItems(): Promise<Array<ClothingItem>> {
    ...
    async getItemById(arg0: bigint): Promise<ClothingItem> {
        if (this.processError) {
            try {
    ...
    async getItemsByCategory(arg0: string): Promise<Array<ClothingItem>> {
        if (this.processError) {
            try {
